                        ...
                        <div class="card-body px-lg-5 py-lg-5">
                            ...
                            @if ($errors->any())
                                ...
                                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                    <p>
                                        <i class="fas fa-exclamation-triangle"></i> @lang('Please fix the following errors &
                                        try again!')
                                    </p>
                                    <ul>
                            ...
                            <form role="form" method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-merge input-group-alternative mb-3">
                                        ...
                                        <input type="text" class="form-control" id="first_name" name="first_name"
                                            ...
                                            aria-label="first_name" aria-describedby="first_name" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group input-group-merge input-group-alternative mb-3">
                                        ...
                                        <input type="text" class="form-control" id="last_name" name="last_name"
                                            ...
                                            aria-label="last_name" aria-describedby="last_name" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group input-group-merge input-group-alternative mb-3">
                                ...
                                <div class="form-group">
                                    <div class="input-group input-group-merge input-group-alternative">
                                        ...
                                        <input type="password" class="form-control is-invalid has-danger"
                                            id="password_confirmation" name="password_confirmation"
                                            placeholder="@lang('Password Confirmation')"
                                            aria-label="@lang('password_confirmation')"

                        ...
                        <div class="card bg-white border-light shadow-soft flex-md-row no-gutters p-4">
                            ...
                            <div class="card-body d-flex flex-column justify-content-between col-auto py-4 p-lg-5">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <h6 class="text-muted small font-weight-normal mb-0 ml-auto"><time
                                            datetime="{{ $$module_name_singular->published_at }}">{{ $$module_name_singular->published_at_formatted }}</time>
                                    </h6>
                                </div>
                            </div>
                        </div>
                    ...
                    @foreach ($$module_name as $$module_name_singular)
                        ...
                        <div class="col-12 col-md-4 mb-4">
                            <div class="card bg-white border-light shadow-soft p-4 rounded">
                                <a href="{{ $details_url }}"><img src="{{ $$module_name_singular->featured_image }}"
                                ...
                                <div class="card-body p-0 pt-4">
                                    ...
                                    <a href="{{ route('frontend.categories.show', [encode_id($$module_name_singular->category_id), $$module_name_singular->category->slug]) }}"
                                        class="badge badge-primary">{{ $$module_name_singular->category_name }}</a>
                                    <p>

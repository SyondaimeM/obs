    ...
    'app' => [
        ...
        'elements' => [
            [
                ...
                'value' => 'Online Branding System', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'string', // data type, string, int, boolean
                ...
                'class' => '', // any class for input
                'value' => 'Group Project', // default value if you want
            ],
            [
    ...
    'meta' => [
        ...
        'elements' => [
            [
                ...
                'class' => '', // any class for input
                'value' => 'Awesome Laravel | A Online Branding System Project', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
            ...
            [
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'Web Application, Laravel,Online Branding System,Bootstrap,Admin,Template,Open,Source, nasir khan, nasirkhan', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
